...
public class GameManager : MonoBehaviour {
    ...
    void Start () {
        ...
        GameObject player2 = (GameObject)Instantiate(Resources.Load<GameObject>("Archer"), new Vector2(1.5f, -1.5f), Quaternion.identity);
        player2.GetComponent<archerController>().isPlayer = false;
