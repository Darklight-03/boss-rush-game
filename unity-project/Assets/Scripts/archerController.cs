	...
	void Update ()
  {
        ...
        while(glcd.isReady()){
          ...
          /* ARROW */
            ...
            snm.sendMessage("spawnprojectile", "{ \"name\": \"" + "arrowOP" + "\" , \"x\": " + bow.transform.position.x + " , \"y\": " + bow.transform.position.y + ", \"rx\": " + bow.transform.rotation.x + ", \"ry\": " + bow.transform.rotation.y + " }");
